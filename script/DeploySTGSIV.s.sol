...
// forge script DeploySTGSIV --rpc-url $ARBITRUM_RPC_URL --broadcast --verify -slow -vv
// forge script DeploySTGSIV --rpc-url $ARBITRUM_RPC_URL --private-key $PRIVATE_KEY --broadcast --verify --skip-simulation --slow -vvvv
...
contract DeploySTGSIV is Script, HelperConfig {
    function run() public {
...

        {
            ...
            string memory filename = "./json/siv_stg.json";
